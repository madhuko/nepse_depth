...
class Nepse:
    def __init__(self):
        ...
        self.getStockDepth_url    ="https://www.nepalstock.com.np/api/nots/nepse-data/marketdepth/{}"
        self.getListedStock_url="https://www.nepalstock.com.np/api/nots/securityDailyTradeStat/{}"
        self.get_all_listed_url="https://www.nepalstock.com.np/api/nots/company/list"
        self.get_market_depth_url="https://www.nepalstock.com.np/api/nots/nepse-data/marketdepth/{}"
